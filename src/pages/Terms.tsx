  ...
  return (
    <main className="min-h-screen bg-bf-bg text-slate-200">
      <section className="mx-auto max-w-3xl px-5 py-12 md:px-8 md:py-16">
        <h1 className="mb-3 text-3xl font-bold text-white md:text-4xl">Terms of Service</h1>
        ...
        <div className="space-y-8 text-base leading-relaxed text-slate-300">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-white">Eligibility</h2>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-white">Insurance Disclosures</h2>
            <p className="text-slate-300">[CONTENT TO BE INSERTED]</p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a className="text-blue-400 hover:text-blue-300" href="mailto:legal@boreal.financial">
                legal@boreal.financial
              </a>
              .
            </p>
          </section>
